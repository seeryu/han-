...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<ul class="sidebar-menu">
			<li class="active"><a href="/mp3"> <i
					class="fa fa-dashboard"></i> <span>Dashboard</span>
			</a></li>

			<li class="active"><a href="/upload" data-toggle="modal"
				data-target="#compose-modal"> <i class="fa fa-laptop"></i> <span>업로드</span>
		...
		<div class="row">
			<c:forEach var="mp3" items="${mp3List}">
				...
				<div class="col-lg-3 col-xs-6">
					...
					<div class="small-box bg-aqua"  >
						...
						<div class="icon">
							<a target="_blank"  class="ion ion-bag" 
                  onclick="window.open('/player?song=${mp3.getfileName()}', 'pop', 'toolbar=no, status=no, scrollbars=no, resizeable=no, width=615, height=415, left=150, top=5')">
                  </a> 

						</div>
						<a href="상세정보" class="small-box-footer"> More info <i
			...
			<!-- COMPOSE MESSAGE MODAL -->
			<div class="modal fade" id="mp3player-modal" tabindex="-1"
				role="dialog" aria-hidden="true">
